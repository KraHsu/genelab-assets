...
| Unitree Go2-W | `unitree_go2w/unitree_go2w.tar.gz` | archive | 16-DoF wheeled quadruped (12 leg joints + 4 driven wheels) mirrored from [unitree_mujoco](https://github.com/unitreerobotics/unitree_mujoco/tree/main/unitree_robots/go2w) (BSD-3-Clause). |
...
| WUJI Cube | `wuji_cube/wuji_cube.tar.gz` | archive | 54 mm textured cube (UV face atlas) for the reorientation task's viewer (visible faces + goal marker). |
